            ...
            <form>
                <div className='container font mt-3  text-secondary'>
                    ...
                    <div className="row mt-3 mb-3">
                        ...
                        <input className='form-control col ' onChange={(e)=>this.setState({name:e.target.value})} placeholder="Enter Your Name"/>
                    </div>
                    <div className="row mt-3 mb-3">
                        <label className="col-2">Email : </label>
                        <input className='form-control col' onChange={(e)=>this.setState({email:e.target.value})} placeholder="Enter Your Email"/>
                    </div>
                    <div className="row mt-3 mb-3">
                        <label className="col-2">Password : </label>
                        <input className='form-control col'  onChange={(e)=>this.setState({password:e.target.value})} placeholder="Enter Your Password"/>
                    </div>
                    <div className="row mt-3 mb-3">
                    ...
                    <div className="row mt-3 mb-3">
                        ...
                        <input className='form-control col'  onChange={(e)=>this.setState({phone:e.target.value})} placeholder="Enter Your Phone Number"/>
                    </div>
                    <div className="row mt-3 mb-3">
                        <label className="col-2">City : </label>
                        <input className='form-control col' onChange={(e)=>this.setState({city:e.target.value})} placeholder="Enter Your City"/>
                    </div>
                    <div className="row mt-3 mb-3">
